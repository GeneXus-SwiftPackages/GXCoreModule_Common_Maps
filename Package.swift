...
let package = Package(
	...
	dependencies: [
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXCoreModule_Common_GeoLocation.git", exact: "1.4.0-beta.16"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Maps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Maps-1.4.0-beta.16.xcframework.zip",
			checksum: "997f2d6ffc81b6893314488e54c0b089a25de690998a57b7e8e0c084a43b6d65"
		)
	]
)