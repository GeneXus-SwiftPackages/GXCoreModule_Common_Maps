...
let package = Package(
	...
	dependencies: [
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXCoreModule_Common_GeoLocation.git", exact: "4.2.0"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Maps",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Maps-4.2.0.xcframework.zip",
			checksum: "82dbacd65ffcc4a4ada27e0e8e8db462e3d74f80a41aae4f6ea80a716538c5c7"
		)
	]
)