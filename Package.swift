...
let package = Package(
	...
	dependencies: [
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXCoreModule_Common_GeoLocation.git", exact: "3.0.7"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Maps",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Maps-3.0.7.xcframework.zip",
			checksum: "b5f7278cc914f6ce7479af2915166bee9b3039c09cac3d67ec52b20a726b5419"
		)
	]
)