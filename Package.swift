...
let package = Package(
	...
	dependencies: [
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXCoreModule_Common_GeoLocation.git", exact: "1.6.0-rc.0"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Maps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Maps-1.6.0-rc.0.xcframework.zip",
			checksum: "658a5a827fe074da691d8146f75af228cd79ebd091d4a291293a9248133aa4d5"
		)
	]
)