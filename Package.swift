...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Maps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Maps-1.0.0-beta+20230306150353.xcframework.zip",
			checksum: "444e0182930a55cdc617873327737dcfae93521d9af140885488b0133ea77921"
		)
	]
)