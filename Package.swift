...
let package = Package(
	...
	dependencies: [
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXCoreModule_Common_GeoLocation.git", exact: "1.1.0-rc.3"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Maps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Maps-1.1.0-rc.3.xcframework.zip",
			checksum: "f8d926d4e7cacd6551f963b7589a1df402db2c8b9024684891af1f2da59d3f05"
		)
	]
)